...
if ( false == get_theme_mod( 't_p_tag', false ) ) { $t_p_tag = esc_html__("Tag", "gnews");  } else { $t_p_tag = get_theme_mod( 't_p_tag' ); }
...
if ( false == get_theme_mod( 't_p_apologies', false ) ) { $t_p_apologies = esc_html__("Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.", "gnews");  } else { $t_p_apologies = get_theme_mod( 't_p_apologies' ); }
