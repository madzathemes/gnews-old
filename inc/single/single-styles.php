...
<?php $ls = get_post_meta(get_the_ID(), "magazin_post_sidebar", true); $fl = "pull-left"; $fs = "pull-right"; $o = get_option("gnews_theme_options"); if(!empty($ls)){ $l = $ls; } else { if(!empty($o['post_sidebar'])){ $l = $o['post_sidebar']; } else { 	$l = "right"; } } if ($l == "left") { $fl = "pull-right"; $fs = "pull-left"; } ?>
    ...
    <div class="row">
      ...
      <div class="single-content col-md-8 <?php echo sanitize_html_class($fl); ?>" >
        ...
        <div class="row">
          ...
          <div class="col-md-11">
            <?php gnews_single_cat(); ?>
            <?php gnews_single_title(); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <?php gnews_single_media(); ?>
            <?php gnews_single_content_frame(); ?>
            <?php gnews_single_bottom_after(); ?>
          </div>
        </div>
      </div>
...
<?php $ls = get_post_meta(get_the_ID(), "magazin_post_sidebar", true); $fl = "pull-left"; $fs = "pull-right"; $o = get_option("gnews_theme_options"); if(!empty($ls)){ $l = $ls; } else { if(!empty($o['post_sidebar'])){ $l = $o['post_sidebar']; } else { 	$l = "left"; } } if ($l == "left") { $fl = "pull-right"; $fs = "pull-left"; } ?>
<div class="post-content-wrap mt-content-container">
  <div class="container">
    <div class="row">
      <div class="single-content col-md-8 <?php echo sanitize_html_class($fl); ?>">
...
<div class="post-media-wrap">
  <div class="container">
      ...
      <?php gnews_single_cat(); ?>
      <?php gnews_single_title(); ?>
    <div class="single-media-top"><?php gnews_single_media(); ?></div>
  </div>
</div>
<div class="post-content-wrap mt-content-container">
  <div class="container">
