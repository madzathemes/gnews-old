<?php function gnews_single_sidebar() {
if ( false == get_theme_mod( 't_p_featured_post', false ) ) { $t_p_featured_post = esc_html__("Featured Post", "gnews");  } else { $t_p_featured_post = get_theme_mod( 't_p_featured_post' ); }
if ( false == get_theme_mod( 't_p_trending_posts', false ) ) { $t_p_trending_posts = esc_html__("Trending Posts", "gnews");  } else { $t_p_trending_posts = get_theme_mod( 't_p_trending_posts' ); }
?>
