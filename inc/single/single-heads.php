<?php function gnews_single_cat() {?>

  <div class="single-cat-wrap"><?php echo get_the_category_list(); ?></div>

<?php } ?>
<?php function gnews_single_cat_posts() {
...
<?php function gnews_single_title() { $subtitle = get_post_meta(get_the_ID(), "magazin_subtitle", true); ?>
...
<?php } ?>
<?php function gnews_single_count() {
$share_top = "";
...
?>
  <div class="after-title">
    ...
    <?php if ( false == get_theme_mod( 't_p_shares', false ) ) { $t_p_shares = esc_html__("Shares", "gnews");  } else { $t_p_shares = get_theme_mod( 't_p_shares' ); } ?>
    <?php if ( false == get_theme_mod( 't_p_views', false ) ) { $t_p_views = esc_html__("Views", "gnews");  } else { $t_p_views = get_theme_mod( 't_p_views' ); } ?>
    <?php if ( false == get_theme_mod( 't_c_comments', false ) ) { $t_c_comments = esc_html__("Comments", "gnews");  } else { $t_c_comments = get_theme_mod( 't_c_comments' ); } ?>
...
<?php } ?>
<?php function gnews_single_share() { ?>
