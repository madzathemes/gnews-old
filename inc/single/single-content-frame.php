<?php function gnews_single_content_frame() { ?>
<?php $review = get_post_meta(get_the_ID(), "magazin_review_location", true); if($review=="before"){ if(function_exists("mt_review_title")) { echo mt_review_single(); }} ?>
    <div class="mt-single-02">
      <div class="row">
        <div class="col-md-1 mt-signle-share-sidebar"><?php gnews_single_share(); ?></div>
        <div class="col-md-11">
          <div><?php gnews_single_count(); ?></div>
          ...
          <div><?php gnews_single_bottom(); ?></div>
        </div>
      </div>
    </div>
