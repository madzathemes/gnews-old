...
add_action( 'tgmpa_register', 'gnews_register_required_plugins' );
/**
 ...
 */
function gnews_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name'			=> esc_html__( "Envato Market","gnews" ), // The plugin name
        ...
        array(
        			'name'     				=> esc_html__( "Page Builder by SiteOrigin","gnews" ), // The plugin name
        			'slug'     				=> 'siteorigin-panels', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
        			'name'     				=> esc_html__( "One Click Demo Import","gnews" ), // The plugin name
        			'slug'     				=> 'one-click-demo-import', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
            'name'			=> esc_html__( "Magazine Plug","gnews" ), // The plugin name
     ...
     */
    $config = array(
      'id'           => 'gnews',                // Unique ID for hashing notices for multiple instances of TGMPA.
